...
export const SIDEBAR_MENU: MenuItem[] = [
  ...
  { id: 'my-cows',      label: '내 소',         href: '/cows',                   icon: 'Cog',             roles: ['master','farmer'],                                                          order: 20,  group: 'core' },
  ...
  { id: 'sensor-cmp',   label: '센서 비교',     href: '/analytics/sensors',      icon: 'Activity',        roles: ['master','veterinarian','government_admin'],                                order: 50,  group: 'analytics' },
  { id: 'region-map',   label: '지역 지도',     href: '/map',                    icon: 'Map',             roles: ['master','government_admin','quarantine_officer'],                          order: 55,  group: 'analytics' },
  ...
  { id: 'alerts',       label: '알림 설정',     href: '/settings/alerts',        icon: 'Bell',            roles: ['master','farmer','veterinarian','government_admin','quarantine_officer'], order: 80,  group: 'core' },
  { id: 'subscription', label: '구독 관리',     href: '/settings/subscription',  icon: 'CreditCard',      roles: ['master','farmer'],                                                          order: 85,  group: 'core' },
